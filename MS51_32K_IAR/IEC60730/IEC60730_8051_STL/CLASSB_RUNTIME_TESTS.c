...
#endif
#if defined __ICC8051__
            printf((char const *)"Watch dog counter reset !!\n");
#endif
        }
    }
...
#endif
#if defined __ICC8051__
            printf((char const *)"runtime CPU reg test: Pass !!\n");
#endif
        }
        else
...
#if defined __ICC8051__
            printf((char const *)"runtime PC test: Pass !!\n");
#endif
        }
        else
...
#endif
#if defined __ICC8051__
            printf((char const *)"runtime Stack test: Pass !!\n");
#endif
        }
        else
...
#endif
#if defined __ICC8051__
            printf((char const *)"runtime RAM test: Pass !!\n");
#endif
        }
        else
...
#endif
#if defined __ICC8051__
            printf((char const *)"runtime ROM test: Pass !!\n");
#endif
        }
        else
...
#endif
#if defined __ICC8051__
            printf((char const *)"runtime ADC test: Pass !!\n");
#endif
        }
        else
...
#endif
#if defined __ICC8051__
            printf((char const *)"runtime MUX test: Pass !!\n");
#endif
        }
        else
...
#endif
#if defined __ICC8051__
            printf((char const *)"runtime Interrupt/Clock test: Pass !!\n");
#endif
        }
        else
